...
return  array(
    ...
    'APP_GROUP_LIST'        => 'Home,Admin,User,Wap',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
    ...
    'DEFAULT_FILTER'        => 'trim', // 默认参数过滤方法 用于 $this->_get('变量名');$this->_post('变量名')...
    ...
    'VAR_FILTERS'           =>  'htmlspecialchars',     // 全局系统变量的默认过滤方法 多个用逗号分割
