...
'license'=>'<div class="license"><h1>系统安装协议</h1>
			...
			<strong>一、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改 微信营销平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>二、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 微信营销平台，还是部份栏目使用 微信营销平台，在你使用了 微信营销平台的网站主页上必须加上 微信营销平台</p>
				<p>4、未经官方许可，禁止在 微信营销平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
...
'install_succ_remark'=>'<p class=\'nest\'>系统安装完成：</p>
		<p class=\'nes\'>1.系统后台地址：<a href=\'http://'.$_SERVER['HTTP_HOST'].trim(str_replace(strstr($_SERVER['SCRIPT_NAME'], '/install'),"",$_SERVER['SCRIPT_NAME'])).'/system.php\' target=\'_blank\'>http://'.$_SERVER['HTTP_HOST'].trim(str_replace(strstr($_SERVER['SCRIPT_NAME'], '/install'),"",$_SERVER['SCRIPT_NAME'])).'/system.php</a></p>
...
<meta content="微信营销平台" name="Copyright" />
