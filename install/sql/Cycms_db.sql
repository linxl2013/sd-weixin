# Host: localhost:3308  (Version: 5.0.51a-community-nt)
# Date: 2013-12-03 12:13:43
# Generator: MySQL-Front 5.3  (Build 4.43)

/*!40101 SET NAMES utf8 */;

#
# Structure for table "Cycms_access"
#

DROP TABLE IF EXISTS `Cycms_access`;
CREATE TABLE `Cycms_access` (
...
#
# Data for table "Cycms_adma"
#

/*!40000 ALTER TABLE `Cycms_adma` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_adma` ENABLE KEYS */;

#
# Structure for table "Cycms_api"
#

DROP TABLE IF EXISTS `Cycms_api`;
CREATE TABLE `Cycms_api` (
  `id` int(11) NOT NULL auto_increment,
  `uid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
  `url` varchar(100) NOT NULL,
...
#
# Data for table "Cycms_api"
#

/*!40000 ALTER TABLE `Cycms_api` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_api` ENABLE KEYS */;

#
# Structure for table "Cycms_areply"
#

DROP TABLE IF EXISTS `Cycms_areply`;
CREATE TABLE `Cycms_areply` (
  `id` int(11) NOT NULL auto_increment,
...
#
# Data for table "Cycms_areply"
#

/*!40000 ALTER TABLE `Cycms_areply` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_areply` ENABLE KEYS */;

#
# Structure for table "Cycms_article"
#

DROP TABLE IF EXISTS `Cycms_article`;
CREATE TABLE `Cycms_article` (
...
#
# Data for table "Cycms_article"
#

/*!40000 ALTER TABLE `Cycms_article` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_article` ENABLE KEYS */;

#
# Structure for table "Cycms_case"
#

DROP TABLE IF EXISTS `Cycms_case`;
CREATE TABLE `Cycms_case` (
  `id` int(11) NOT NULL auto_increment,
...
#
# Data for table "Cycms_case"
#

/*!40000 ALTER TABLE `Cycms_case` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_case` ENABLE KEYS */;

#
# Structure for table "Cycms_classify"
#

DROP TABLE IF EXISTS `Cycms_classify`;
CREATE TABLE `Cycms_classify` (
  `id` int(11) NOT NULL auto_increment,
  `name` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_classify"
#

/*!40000 ALTER TABLE `Cycms_classify` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_classify` ENABLE KEYS */;

#
# Structure for table "Cycms_company"
#

DROP TABLE IF EXISTS `Cycms_company`;
CREATE TABLE `Cycms_company` (
...
#
# Data for table "Cycms_company"
#

/*!40000 ALTER TABLE `Cycms_company` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_company` ENABLE KEYS */;

#
# Structure for table "Cycms_diymen_class"
#

DROP TABLE IF EXISTS `Cycms_diymen_class`;
CREATE TABLE `Cycms_diymen_class` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `pid` int(11) NOT NULL,
...
#
# Data for table "Cycms_diymen_class"
#

/*!40000 ALTER TABLE `Cycms_diymen_class` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_diymen_class` ENABLE KEYS */;

#
# Structure for table "Cycms_diymen_set"
#

DROP TABLE IF EXISTS `Cycms_diymen_set`;
CREATE TABLE `Cycms_diymen_set` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_diymen_set"
#

/*!40000 ALTER TABLE `Cycms_diymen_set` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_diymen_set` ENABLE KEYS */;

#
# Structure for table "Cycms_dream"
#

DROP TABLE IF EXISTS `Cycms_dream`;
CREATE TABLE `Cycms_dream` (
  `id` int(11) NOT NULL auto_increment,
...
#
# Data for table "Cycms_flash"
#

/*!40000 ALTER TABLE `Cycms_flash` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_flash` ENABLE KEYS */;

#
# Structure for table "Cycms_function"
#

DROP TABLE IF EXISTS `Cycms_function`;
CREATE TABLE `Cycms_function` (
  `id` int(11) NOT NULL auto_increment,
...
#
# Data for table "Cycms_function"
#

/*!40000 ALTER TABLE `Cycms_function` DISABLE KEYS */;
INSERT INTO `Cycms_function` VALUES (1,1,0,'天气查询','tianqi','天气查询服务:例  城市名+天气',1,1),(2,1,0,'糗事','qiushi','糗事　直接发送糗事',1,1),(3,1,0,'计算器','jishuan','计算器使用方法　例：计算50-50　，计算100*100',1,1),(4,4,0,'朗读','langdu','朗读＋关键词　例：朗读pigcms多用户营销系统',1,1),(5,1,0,'健康指数查询','jiankang','健康指数查询　健康＋高，＋重　例：健康170,65',1,1),(6,1,0,'快递查询','kuaidi','快递＋快递名＋快递号　例：快递顺丰117215889174',1,1),(7,1,0,'笑话','xiaohua','笑话　直接发送笑话',1,1),(8,2,0,'藏头诗','changtoushi',' 藏头诗+关键词　例：藏头诗我爱你',1,1),(9,1,0,'陪聊','peiliao','聊天　直接输入聊天关键词即可',1,1),(10,1,0,'聊天','liaotian','聊天　直接输入聊天关键词即可',1,1),(11,3,0,'周公解梦','mengjian','周公解梦　梦见+关键词　例如:梦见父母',1,1),(12,2,0,'语音翻译','yuyinfanyi','翻译＋关键词 例：翻译你好',1,1),(13,2,0,'火车查询','huoche','火车查询　火车＋城市＋目的地　例火车上海南京',1,1),(14,2,0,'公交查询','gongjiao','公交＋城市＋公交编号　例：上海公交774',1,1),(15,2,0,'身份证查询','shenfenzheng','身份证＋号码　　例：身份证342423198803015568',1,1),(16,1,0,'手机归属地查询','shouji','手机归属地查询(吉凶 运势) 手机＋手机号码　例：手机13917778912',1,1),(17,3,0,'音乐查询','yinle','音乐＋音乐名  例：音乐爱你一万年',1,1),(18,1,0,'附近周边信息查询','fujin','附近周边信息查询(ＬＢＳ）',1,1),(19,4,0,'幸运大转盘','choujiang','输入抽奖　即可参加幸运大转盘抽奖活动',2,1),(20,3,0,'淘宝店铺','taobao','输入淘宝＋关键词　即可访问淘宝3g手机店铺',2,1),(21,4,0,'会员资料管理','userinfo','会员资料管理　输入会员　即可参与',2,1),(22,1,0,'翻译','fanyi','翻译＋关键词 例：翻译你好',1,1),(23,4,0,'第三方接口','api','第三方接口整合模块，请在管理平台下载接口文件并配置接口信息，',1,1),(24,1,0,'姓名算命','suanming','姓名算命 算命＋关键词　例：算命李白',1,1),(25,3,0,'百度百科','baike','百度百科　使用方法：百科＋关键词　例：百科北京',2,1),(26,2,0,'彩票查询','caipiao','回复内容:彩票+彩种即可查询彩票中奖信息,例：彩票双色球',1,1),(27,4,0,'抽奖','choujiang','抽奖,输入抽奖即可参加幸运大转盘',1,1),(28,4,0,'刮刮卡','gua2','刮刮卡抽奖活动',1,1),(29,1,0,'3G首页','shouye','输入首页,访问微3g 网站',1,1),(30,1,0,'DIY宣传页','adma','DIY宣传页,用于创建二维码宣传页权限开启',1,1),(31,4,0,'会员卡','huiyuanka','尊贵享受vip会员卡,回复会员卡即可领取会员卡',1,1),(32,4,0,'官网帐号审核','shenhe','官网帐号审核',1,1),(33,1,0,'歌词查询','geci','歌词查询 回复歌词＋歌名即可查询一首歌曲的歌词,例：歌词醉清风',1,1),(34,2,0,'域名whois查询','yuming','域名whois查询　回复域名＋域名 可查询网站备案信息,域名whois注册时间等等\r\n 例：域名jiawoyige.com',1,1),(35,4,0,'通用预订系统','host_kev','通用预订系统 可用于酒店预订，ktv订房，旅游预订等。',2,1),(36,4,0,'自定义表单','diyform','自定义表单(用于报名，预约,留言)等',1,1),(37,2,0,'无线网络订餐','dx','无线网络订餐',1,1),(38,2,0,'在线商城','shop','在线商城,购买系统',1,1),(39,2,0,'在线团购系统','etuan','在线团购系统',1,1),(40,4,0,'自定义菜单','diymen_set','自定义菜单,一键生成轻app',1,1);
/*!40000 ALTER TABLE `Cycms_function` ENABLE KEYS */;

#
# Structure for table "Cycms_home"
#

DROP TABLE IF EXISTS `Cycms_home`;
CREATE TABLE `Cycms_home` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `title` varchar(30) NOT NULL,
...
#
# Data for table "Cycms_home"
#

/*!40000 ALTER TABLE `Cycms_home` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_home` ENABLE KEYS */;

#
# Structure for table "Cycms_host"
#

DROP TABLE IF EXISTS `Cycms_host`;
CREATE TABLE `Cycms_host` (
  `id` int(11) NOT NULL auto_increment,
...
#
# Data for table "Cycms_host"
#

/*!40000 ALTER TABLE `Cycms_host` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_host` ENABLE KEYS */;

#
# Structure for table "Cycms_host_list_add"
#

DROP TABLE IF EXISTS `Cycms_host_list_add`;
CREATE TABLE `Cycms_host_list_add` (
...
#
# Data for table "Cycms_host_list_add"
#

/*!40000 ALTER TABLE `Cycms_host_list_add` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_host_list_add` ENABLE KEYS */;

#
# Structure for table "Cycms_host_order"
#

DROP TABLE IF EXISTS `Cycms_host_order`;
CREATE TABLE `Cycms_host_order` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `token` varchar(50) NOT NULL,
...
#
# Data for table "Cycms_host_order"
#

/*!40000 ALTER TABLE `Cycms_host_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_host_order` ENABLE KEYS */;

#
# Structure for table "Cycms_img"
#

DROP TABLE IF EXISTS `Cycms_img`;
CREATE TABLE `Cycms_img` (
  `id` int(11) NOT NULL auto_increment,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
...
#
# Data for table "Cycms_img"
#

/*!40000 ALTER TABLE `Cycms_img` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_img` ENABLE KEYS */;

#
# Structure for table "Cycms_indent"
#

DROP TABLE IF EXISTS `Cycms_indent`;
CREATE TABLE `Cycms_indent` (
  `id` int(11) NOT NULL auto_increment,
  `uid` int(11) NOT NULL,
...
#
# Data for table "Cycms_indent"
#

/*!40000 ALTER TABLE `Cycms_indent` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_indent` ENABLE KEYS */;

#
# Structure for table "Cycms_keyword"
#

DROP TABLE IF EXISTS `Cycms_keyword`;
CREATE TABLE `Cycms_keyword` (
  `id` int(11) NOT NULL auto_increment,
  `keyword` char(255) NOT NULL,
  `pid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_keyword"
#

/*!40000 ALTER TABLE `Cycms_keyword` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_keyword` ENABLE KEYS */;

#
# Structure for table "Cycms_links"
#

DROP TABLE IF EXISTS `Cycms_links`;
CREATE TABLE `Cycms_links` (
  `id` int(11) NOT NULL auto_increment,
  `name` varchar(60) NOT NULL,
  `url` char(255) NOT NULL,
  `status` varchar(1) NOT NULL,
...
#
# Data for table "Cycms_links"
#

/*!40000 ALTER TABLE `Cycms_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_links` ENABLE KEYS */;

#
# Structure for table "Cycms_lottery"
#

DROP TABLE IF EXISTS `Cycms_lottery`;
CREATE TABLE `Cycms_lottery` (
  `id` int(11) NOT NULL auto_increment,
...
#
# Data for table "Cycms_lottery"
#

/*!40000 ALTER TABLE `Cycms_lottery` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_lottery` ENABLE KEYS */;

#
# Structure for table "Cycms_lottery_record"
#

DROP TABLE IF EXISTS `Cycms_lottery_record`;
CREATE TABLE `Cycms_lottery_record` (
  `id` int(11) NOT NULL auto_increment,
  `lid` int(11) NOT NULL,
...
#
# Data for table "Cycms_lottery_record"
#

/*!40000 ALTER TABLE `Cycms_lottery_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_lottery_record` ENABLE KEYS */;

#
# Structure for table "Cycms_member"
#

DROP TABLE IF EXISTS `Cycms_member`;
CREATE TABLE `Cycms_member` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_member"
#

/*!40000 ALTER TABLE `Cycms_member` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_member` ENABLE KEYS */;

#
# Structure for table "Cycms_member_card_contact"
#

DROP TABLE IF EXISTS `Cycms_member_card_contact`;
CREATE TABLE `Cycms_member_card_contact` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_member_card_contact"
#

/*!40000 ALTER TABLE `Cycms_member_card_contact` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_member_card_contact` ENABLE KEYS */;

#
# Structure for table "Cycms_member_card_coupon"
#

DROP TABLE IF EXISTS `Cycms_member_card_coupon`;
CREATE TABLE `Cycms_member_card_coupon` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_member_card_coupon"
#

/*!40000 ALTER TABLE `Cycms_member_card_coupon` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_member_card_coupon` ENABLE KEYS */;

#
# Structure for table "Cycms_member_card_create"
#

DROP TABLE IF EXISTS `Cycms_member_card_create`;
CREATE TABLE `Cycms_member_card_create` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_member_card_create"
#

/*!40000 ALTER TABLE `Cycms_member_card_create` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_member_card_create` ENABLE KEYS */;

#
# Structure for table "Cycms_member_card_exchange"
#

DROP TABLE IF EXISTS `Cycms_member_card_exchange`;
CREATE TABLE `Cycms_member_card_exchange` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_member_card_exchange"
#

/*!40000 ALTER TABLE `Cycms_member_card_exchange` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_member_card_exchange` ENABLE KEYS */;

#
# Structure for table "Cycms_member_card_info"
#

DROP TABLE IF EXISTS `Cycms_member_card_info`;
CREATE TABLE `Cycms_member_card_info` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `info` varchar(200) NOT NULL,
...
#
# Data for table "Cycms_member_card_info"
#

/*!40000 ALTER TABLE `Cycms_member_card_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_member_card_info` ENABLE KEYS */;

#
# Structure for table "Cycms_member_card_integral"
#

DROP TABLE IF EXISTS `Cycms_member_card_integral`;
CREATE TABLE `Cycms_member_card_integral` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_member_card_integral"
#

/*!40000 ALTER TABLE `Cycms_member_card_integral` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_member_card_integral` ENABLE KEYS */;

#
# Structure for table "Cycms_member_card_set"
#

DROP TABLE IF EXISTS `Cycms_member_card_set`;
CREATE TABLE `Cycms_member_card_set` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_member_card_set"
#

/*!40000 ALTER TABLE `Cycms_member_card_set` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_member_card_set` ENABLE KEYS */;

#
# Structure for table "Cycms_member_card_sign"
#

DROP TABLE IF EXISTS `Cycms_member_card_sign`;
CREATE TABLE `Cycms_member_card_sign` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(50) NOT NULL,
  `wecha_id` varchar(50) NOT NULL,
...
#
# Data for table "Cycms_member_card_sign"
#

/*!40000 ALTER TABLE `Cycms_member_card_sign` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_member_card_sign` ENABLE KEYS */;

#
# Structure for table "Cycms_member_card_vip"
#

DROP TABLE IF EXISTS `Cycms_member_card_vip`;
CREATE TABLE `Cycms_member_card_vip` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
  `group` tinyint(1) NOT NULL,
...
#
# Data for table "Cycms_member_card_vip"
#

/*!40000 ALTER TABLE `Cycms_member_card_vip` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_member_card_vip` ENABLE KEYS */;

#
# Structure for table "Cycms_menuplus"
#

DROP TABLE IF EXISTS `Cycms_menuplus`;
CREATE TABLE `Cycms_menuplus` (
  `id` int(11) NOT NULL auto_increment,
  `uid` int(11) NOT NULL,
  `token` varchar(255) NOT NULL COMMENT 'token',
  `menupluscolor` varchar(255) NOT NULL COMMENT '导航键背景色',
  `copyright` varchar(255) NOT NULL COMMENT '公众号版权',
  `tel_url` varchar(255) NOT NULL COMMENT '电话外链',
  `tel_sort` tinyint(3) NOT NULL COMMENT '电话排序',
  `tel_display` tinyint(1) NOT NULL COMMENT '电话是否显示',
  `memberinfo_url` varchar(255) NOT NULL COMMENT '会员资料外链',
  `memberinfo_sort` tinyint(3) NOT NULL COMMENT '会员资料排序',
  `memberinfo_display` tinyint(1) NOT NULL COMMENT '会员资料是否显示',
  `guide_url` varchar(255) NOT NULL COMMENT '导航外链',
  `guide_sort` tinyint(3) NOT NULL COMMENT '导航排序',
  `guide_display` tinyint(1) NOT NULL COMMENT '导航是否显示',
  `share_url` varchar(255) NOT NULL COMMENT '分享外链',
  `share_sort` tinyint(3) NOT NULL COMMENT '分享排序',
  `share_display` tinyint(1) NOT NULL COMMENT '分享是否显示',
  `home_url` varchar(255) NOT NULL COMMENT '首页外链',
  `home_sort` tinyint(3) NOT NULL COMMENT '首页排序',
  `home_display` tinyint(1) NOT NULL COMMENT '首页',
  `album_url` varchar(255) NOT NULL COMMENT '相册外链',
  `album_sort` tinyint(3) NOT NULL COMMENT '相册排序',
  `album_display` tinyint(1) NOT NULL COMMENT '相册是否显示',
  `mail_url` varchar(255) NOT NULL COMMENT '邮箱外链',
  `mail_sort` tinyint(3) NOT NULL COMMENT '邮箱排序',
  `mail_display` tinyint(1) NOT NULL COMMENT '邮箱是否显示',
  `shop_url` varchar(255) NOT NULL COMMENT '商城外链',
  `shop_sort` tinyint(3) NOT NULL COMMENT '商城排序',
  `shop_display` tinyint(1) NOT NULL COMMENT '商城是否显示',
  `membercard_url` varchar(255) NOT NULL COMMENT '会员卡外链',
  `membercard_sort` tinyint(3) NOT NULL COMMENT '会员卡排序',
  `membercard_display` tinyint(1) NOT NULL COMMENT '会员卡',
  `event_url` varchar(255) NOT NULL COMMENT '活动外链',
  `event_sort` tinyint(3) NOT NULL COMMENT '活动排序',
  `event_display` tinyint(1) NOT NULL COMMENT '活动是否显示',
  `sinawb_url` varchar(255) NOT NULL COMMENT '新浪微博外链',
  `sinawb_sort` tinyint(3) NOT NULL COMMENT '新浪微博排序',
  `sinawb_display` tinyint(1) NOT NULL COMMENT '新浪微博是否显示',
  `qqwb_url` varchar(255) NOT NULL COMMENT 'QQ微博外链',
  `qqwb_sort` tinyint(3) NOT NULL COMMENT 'QQ微博排序',
  `qqwb_display` tinyint(1) NOT NULL COMMENT 'QQ微博是否显示',
  `qzone_url` varchar(255) NOT NULL COMMENT 'QQ空间外链',
  `qzone_sort` tinyint(3) NOT NULL COMMENT 'QQ空间排序',
  `qzone_display` tinyint(1) NOT NULL COMMENT 'QQ空间是否显示',
  `music_url` varchar(255) NOT NULL COMMENT '音乐外链',
  `music_sort` tinyint(3) NOT NULL COMMENT '音乐排序',
  `music_display` tinyint(1) NOT NULL COMMENT '音乐是否显示',
  `video_url` varchar(255) NOT NULL COMMENT '视频外链',
  `video_sort` tinyint(3) NOT NULL COMMENT '视频排序',
  `video_display` tinyint(1) NOT NULL COMMENT '视频是否显示',
  `recommend_url` varchar(255) NOT NULL COMMENT '推荐外链',
  `recommend_sort` tinyint(3) NOT NULL COMMENT '推荐排序',
  `recommend_display` tinyint(1) NOT NULL COMMENT '推荐是否显示',
  `other_url` varchar(255) NOT NULL COMMENT '其它外链',
  `other_sort` tinyint(3) NOT NULL COMMENT '其它排序',
  `other_display` tinyint(1) NOT NULL COMMENT '其它是否显示',
  PRIMARY KEY  (`id`),
  KEY `uid` USING BTREE (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

#
# Data for table "Cycms_menuplus"
#

/*!40000 ALTER TABLE `Cycms_menuplus` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_menuplus` ENABLE KEYS */;

#
# Structure for table "Cycms_nearby_user"
#

DROP TABLE IF EXISTS `Cycms_nearby_user`;
CREATE TABLE `Cycms_nearby_user` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(30) NOT NULL,
...
#
# Data for table "Cycms_nearby_user"
#

/*!40000 ALTER TABLE `Cycms_nearby_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_nearby_user` ENABLE KEYS */;

#
# Structure for table "Cycms_node"
#

DROP TABLE IF EXISTS `Cycms_node`;
CREATE TABLE `Cycms_node` (
...
#
# Data for table "Cycms_node"
#

/*!40000 ALTER TABLE `Cycms_node` DISABLE KEYS */;
INSERT INTO `Cycms_node` VALUES (1,'cms','根节点',1,'',0,1,NULL,0,0),(2,'Site','站点管理',1,'',1,0,NULL,0,1),(3,'User','用户管理',1,'',1,0,NULL,0,1),(4,'extent','扩展管理',1,'',1,0,NULL,0,1),(5,'article','内容管理',1,'',1,0,NULL,0,1),(6,'Site','站点设置',1,'',2,2,NULL,0,2),(7,'index','基本信息设置',1,'',6,3,NULL,0,2),(8,'safe','安全设置',1,'',6,3,NULL,0,2),(9,'email','邮箱设置',1,'',6,3,NULL,0,2),(10,'upfile','附件设置',1,'',6,3,NULL,0,2),(11,'Node','节点管理',1,NULL,2,2,NULL,0,2),(12,'add','添加节点',1,'',11,3,NULL,0,2),(13,'index','节点列表',1,'',11,3,NULL,0,2),(14,'insert','写入',1,'0',11,3,NULL,0,0),(15,'edit','编辑节点',1,'0',11,3,NULL,0,0),(16,'update','更新节点',1,'0',11,3,NULL,0,0),(17,'del','删除节点',1,'0',11,3,NULL,0,0),(18,'User','用户中心',1,'0',3,2,NULL,0,2),(19,'add','添加用户',1,'0',18,3,NULL,0,2),(20,'index','用户列表',1,'0',18,3,NULL,0,2),(21,'edit','编辑用户',1,'0',18,3,NULL,0,0),(22,'insert','写入数据库',1,'0',18,3,NULL,0,0),(23,'update','更新用户',1,'0',18,3,NULL,0,0),(24,'del','删除用户',1,'0',18,3,NULL,0,0),(25,'Group','管理组',1,'0',3,2,NULL,0,2),(26,'add','创建用户组',1,'0',25,3,NULL,0,2),(27,'index','用户组列表',1,'0',25,3,NULL,0,2),(28,'edit','编辑用户组',1,'0',25,3,NULL,0,0),(29,'del','删除用户组',1,'0',25,3,NULL,0,0),(30,'insert','写入数据库',1,'0',25,3,NULL,0,0),(31,'update','更新用户组',1,'0',25,3,NULL,0,0),(32,'insert','保存测试',1,'0',6,3,NULL,0,0),(33,'System','首页',1,'0',2,2,NULL,0,0),(34,'menu','左侧栏',1,'0',33,3,NULL,0,0),(35,'main','右侧栏目',1,'0',33,3,NULL,0,0),(36,'Article','微信图文',1,'0',5,2,NULL,0,2),(37,'index','图文列表',1,'0',36,3,NULL,0,2),(38,'add','图文添加',1,'0',36,3,NULL,0,2),(39,'edit','微信图文编辑',1,'0',36,3,NULL,0,0),(40,'del','微信图文删除',1,'0',36,3,NULL,0,0),(41,'Function','功能模块',1,'0',1,0,NULL,0,1),(42,'Function','功能模块',1,'0',41,2,NULL,0,2),(43,'add','添加模块',1,'0',42,3,NULL,0,2),(44,'User_group','会员组',1,'0',3,2,NULL,0,2),(45,'add','添加会员组',1,'0',44,3,NULL,0,2),(46,'Users','前台用户',1,'0',3,2,NULL,0,2),(47,'index','用户列表',1,'0',46,3,NULL,0,0),(48,'add','添加用户',1,'0',46,3,NULL,0,2),(49,'edit','编辑用户',1,'0',46,3,NULL,0,0),(50,'del','删除用户',1,'0',46,3,NULL,0,0),(51,'insert','写入数据库',1,'0',46,3,NULL,0,0),(52,'upsave','更新用户',1,'0',46,3,NULL,0,0),(53,'Text','微信文本',1,'0',5,2,NULL,0,2),(54,'index','文本列表',1,'0',53,3,NULL,0,2),(55,'del','删除',1,'0',53,3,NULL,0,0),(56,'Custom','自定义页面',1,'0',5,2,NULL,0,2),(57,'index','列表',1,'0',56,3,NULL,0,2),(58,'edit','编辑',1,'0',56,3,NULL,0,0),(59,'del','删除',1,'0',56,3,NULL,0,0),(60,'Records','充值记录',1,'0',4,2,NULL,0,2),(61,'index','充值列表',1,'0',56,3,NULL,0,2),(62,'Case','用户案例',1,'0',4,2,NULL,0,2),(63,'index','案例列表',1,'0',62,3,NULL,0,2),(64,'add','添加案例',1,'0',62,3,NULL,0,2),(65,'edit','编辑案例',1,'0',62,3,NULL,0,0),(66,'del','删除案例',1,'0',62,3,NULL,0,0),(67,'insert','写入数据库',1,'0',62,3,NULL,0,0),(68,'upsave','更新数据库',1,'0',62,3,NULL,0,0),(69,'Links','友情链接',1,'0',4,2,NULL,0,2),(70,'index','友情链接',1,'0',68,3,NULL,0,2),(71,'add','添加链接',1,'0',68,3,NULL,0,2),(72,'edit','编辑链接',1,'0',68,3,NULL,0,0),(73,'insert','插入数据库',1,'0',68,3,NULL,0,0),(74,'upsave','更新数据库',1,'0',68,3,NULL,0,0),(75,'del','删除友情链接',1,'0',68,3,NULL,0,0),(76,'token','公众号管理',1,'0',1,2,NULL,0,1),(77,'Token','公众号管理',1,'0',76,2,NULL,0,2),(78,'alipay','在线支付接口',1,'0',6,3,NULL,0,2);
/*!40000 ALTER TABLE `Cycms_node` ENABLE KEYS */;

#
# Structure for table "Cycms_order"
#

DROP TABLE IF EXISTS `Cycms_order`;
CREATE TABLE `Cycms_order` (
  `id` int(11) NOT NULL auto_increment,
...
#
# Data for table "Cycms_order"
#

/*!40000 ALTER TABLE `Cycms_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_order` ENABLE KEYS */;

#
# Structure for table "Cycms_ordering_class"
#

DROP TABLE IF EXISTS `Cycms_ordering_class`;
CREATE TABLE `Cycms_ordering_class` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_ordering_class"
#

/*!40000 ALTER TABLE `Cycms_ordering_class` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_ordering_class` ENABLE KEYS */;

#
# Structure for table "Cycms_ordering_set"
#

DROP TABLE IF EXISTS `Cycms_ordering_set`;
CREATE TABLE `Cycms_ordering_set` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `keyword` varchar(10) NOT NULL,
  `title` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_ordering_set"
#

/*!40000 ALTER TABLE `Cycms_ordering_set` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_ordering_set` ENABLE KEYS */;

#
# Structure for table "Cycms_other"
#

DROP TABLE IF EXISTS `Cycms_other`;
CREATE TABLE `Cycms_other` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_other"
#

/*!40000 ALTER TABLE `Cycms_other` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_other` ENABLE KEYS */;

#
# Structure for table "Cycms_photo"
#

DROP TABLE IF EXISTS `Cycms_photo`;
CREATE TABLE `Cycms_photo` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `title` varchar(20) NOT NULL,
  `picurl` varchar(100) NOT NULL,
...
#
# Data for table "Cycms_photo"
#

/*!40000 ALTER TABLE `Cycms_photo` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_photo` ENABLE KEYS */;

#
# Structure for table "Cycms_photo_list"
#

DROP TABLE IF EXISTS `Cycms_photo_list`;
CREATE TABLE `Cycms_photo_list` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `pid` int(11) NOT NULL,
  `title` varchar(20) NOT NULL,
...
#
# Data for table "Cycms_photo_list"
#

/*!40000 ALTER TABLE `Cycms_photo_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_photo_list` ENABLE KEYS */;

#
# Structure for table "Cycms_product"
#

DROP TABLE IF EXISTS `Cycms_product`;
CREATE TABLE `Cycms_product` (
  `id` int(10) NOT NULL auto_increment,
...
#
# Data for table "Cycms_product"
#

/*!40000 ALTER TABLE `Cycms_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_product` ENABLE KEYS */;

#
# Structure for table "Cycms_product_cart"
#

DROP TABLE IF EXISTS `Cycms_product_cart`;
CREATE TABLE `Cycms_product_cart` (
  `id` int(10) NOT NULL auto_increment,
  `token` varchar(50) NOT NULL default '',
...
#
# Data for table "Cycms_product_cart"
#

/*!40000 ALTER TABLE `Cycms_product_cart` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_product_cart` ENABLE KEYS */;

#
# Structure for table "Cycms_product_cart_list"
#

DROP TABLE IF EXISTS `Cycms_product_cart_list`;
CREATE TABLE `Cycms_product_cart_list` (
  `id` int(10) NOT NULL auto_increment,
...
#
# Data for table "Cycms_product_cart_list"
#

/*!40000 ALTER TABLE `Cycms_product_cart_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_product_cart_list` ENABLE KEYS */;

#
# Structure for table "Cycms_product_cat"
#

DROP TABLE IF EXISTS `Cycms_product_cat`;
CREATE TABLE `Cycms_product_cat` (
...
#
# Data for table "Cycms_product_cat"
#

/*!40000 ALTER TABLE `Cycms_product_cat` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_product_cat` ENABLE KEYS */;

#
# Structure for table "Cycms_product_diningtable"
#

DROP TABLE IF EXISTS `Cycms_product_diningtable`;
CREATE TABLE `Cycms_product_diningtable` (
  `id` mediumint(4) NOT NULL auto_increment,
  `token` varchar(50) NOT NULL default '',
...
#
# Data for table "Cycms_product_diningtable"
#

/*!40000 ALTER TABLE `Cycms_product_diningtable` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_product_diningtable` ENABLE KEYS */;

#
# Structure for table "Cycms_reply_info"
#

DROP TABLE IF EXISTS `Cycms_reply_info`;
CREATE TABLE `Cycms_reply_info` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_reply_info"
#

/*!40000 ALTER TABLE `Cycms_reply_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_reply_info` ENABLE KEYS */;

#
# Structure for table "Cycms_requestdata"
#

DROP TABLE IF EXISTS `Cycms_requestdata`;
CREATE TABLE `Cycms_requestdata` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `year` int(4) NOT NULL,
...
#
# Data for table "Cycms_requestdata"
#

/*!40000 ALTER TABLE `Cycms_requestdata` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_requestdata` ENABLE KEYS */;

#
# Structure for table "Cycms_role"
#

DROP TABLE IF EXISTS `Cycms_role`;
CREATE TABLE `Cycms_role` (
  `id` smallint(6) unsigned NOT NULL auto_increment,
...
#
# Data for table "Cycms_role"
#

/*!40000 ALTER TABLE `Cycms_role` DISABLE KEYS */;
INSERT INTO `Cycms_role` VALUES (1,'超级管理员',0,1,0,''),(2,'演示组',0,1,0,''),(3,'普通会员',0,1,0,'');
/*!40000 ALTER TABLE `Cycms_role` ENABLE KEYS */;

#
# Structure for table "Cycms_role_user"
#

DROP TABLE IF EXISTS `Cycms_role_user`;
CREATE TABLE `Cycms_role_user` (
...
#
# Data for table "Cycms_role_user"
#

/*!40000 ALTER TABLE `Cycms_role_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_role_user` ENABLE KEYS */;

#
# Structure for table "Cycms_selfform"
#

DROP TABLE IF EXISTS `Cycms_selfform`;
CREATE TABLE `Cycms_selfform` (
  `id` int(10) NOT NULL auto_increment,
...
#
# Data for table "Cycms_selfform"
#

/*!40000 ALTER TABLE `Cycms_selfform` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_selfform` ENABLE KEYS */;

#
# Structure for table "Cycms_selfform_input"
#

DROP TABLE IF EXISTS `Cycms_selfform_input`;
CREATE TABLE `Cycms_selfform_input` (
  `id` int(10) NOT NULL auto_increment,
...
#
# Data for table "Cycms_selfform_input"
#

/*!40000 ALTER TABLE `Cycms_selfform_input` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_selfform_input` ENABLE KEYS */;

#
# Structure for table "Cycms_selfform_value"
#

DROP TABLE IF EXISTS `Cycms_selfform_value`;
CREATE TABLE `Cycms_selfform_value` (
  `id` int(10) NOT NULL auto_increment,
  `formid` int(10) NOT NULL default '0',
...
#
# Data for table "Cycms_selfform_value"
#

/*!40000 ALTER TABLE `Cycms_selfform_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_selfform_value` ENABLE KEYS */;

#
# Structure for table "Cycms_snccode"
#

DROP TABLE IF EXISTS `Cycms_snccode`;
CREATE TABLE `Cycms_snccode` (
  `id` int(11) NOT NULL auto_increment,
  `type` int(1) NOT NULL,
  `status` int(1) NOT NULL,
...
#
# Data for table "Cycms_snccode"
#

/*!40000 ALTER TABLE `Cycms_snccode` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_snccode` ENABLE KEYS */;

#
# Structure for table "Cycms_system_info"
#

DROP TABLE IF EXISTS `Cycms_system_info`;
CREATE TABLE `Cycms_system_info` (
  `lastsqlupdate` int(10) NOT NULL,
  `version` varchar(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

#
# Data for table "Cycms_system_info"
#

/*!40000 ALTER TABLE `Cycms_system_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_system_info` ENABLE KEYS */;

#
# Structure for table "Cycms_taobao"
#

DROP TABLE IF EXISTS `Cycms_taobao`;
CREATE TABLE `Cycms_taobao` (
  `id` int(11) NOT NULL auto_increment,
...
#
# Data for table "Cycms_taobao"
#

/*!40000 ALTER TABLE `Cycms_taobao` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_taobao` ENABLE KEYS */;

#
# Structure for table "Cycms_text"
#

DROP TABLE IF EXISTS `Cycms_text`;
CREATE TABLE `Cycms_text` (
  `id` int(11) NOT NULL auto_increment,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
  `keyword` char(255) NOT NULL,
...
#
# Data for table "Cycms_text"
#

/*!40000 ALTER TABLE `Cycms_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_text` ENABLE KEYS */;

#
# Structure for table "Cycms_token_open"
#

DROP TABLE IF EXISTS `Cycms_token_open`;
CREATE TABLE `Cycms_token_open` (
  `id` int(11) NOT NULL auto_increment,
  `uid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_token_open"
#

/*!40000 ALTER TABLE `Cycms_token_open` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_token_open` ENABLE KEYS */;

#
# Structure for table "Cycms_user"
#

DROP TABLE IF EXISTS `Cycms_user`;
CREATE TABLE `Cycms_user` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
#
# Data for table "Cycms_user"
#

/*!40000 ALTER TABLE `Cycms_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_user` ENABLE KEYS */;

#
# Structure for table "Cycms_user_group"
#

DROP TABLE IF EXISTS `Cycms_user_group`;
CREATE TABLE `Cycms_user_group` (
  `id` int(11) NOT NULL auto_increment,
...
#
# Data for table "Cycms_user_group"
#

/*!40000 ALTER TABLE `Cycms_user_group` DISABLE KEYS */;
INSERT INTO `Cycms_user_group` VALUES (1,'vip0',2000,2000,0,0,0,0,10,1,4),(2,'vip1',3000,3000,1,2,1,0,50,1,4),(3,'vip2',4000,4000,1,4,50,0,80,1,4),(4,'vip3',5000,5000,1,5,300,0,1000,1,4);
/*!40000 ALTER TABLE `Cycms_user_group` ENABLE KEYS */;

#
# Structure for table "Cycms_user_request"
#

DROP TABLE IF EXISTS `Cycms_user_request`;
CREATE TABLE `Cycms_user_request` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(30) NOT NULL,
  `uid` varchar(32) NOT NULL,
  `keyword` varchar(100) NOT NULL,
...
#
# Data for table "Cycms_user_request"
#

/*!40000 ALTER TABLE `Cycms_user_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_user_request` ENABLE KEYS */;

#
# Structure for table "Cycms_userinfo"
#

DROP TABLE IF EXISTS `Cycms_userinfo`;
CREATE TABLE `Cycms_userinfo` (
  `id` int(11) NOT NULL auto_increment,
  `token` varchar(60) NOT NULL,
  `wecha_id` varchar(60) NOT NULL,
  `wechaname` varchar(60) NOT NULL,
...
#
# Data for table "Cycms_userinfo"
#

/*!40000 ALTER TABLE `Cycms_userinfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_userinfo` ENABLE KEYS */;

#
# Structure for table "Cycms_users"
#

DROP TABLE IF EXISTS `Cycms_users`;
CREATE TABLE `Cycms_users` (
  `id` int(11) NOT NULL auto_increment,
  `gid` int(11) NOT NULL,
...
#
# Data for table "Cycms_users"
#

/*!40000 ALTER TABLE `Cycms_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_users` ENABLE KEYS */;

#
# Structure for table "Cycms_voiceresponse"
#

DROP TABLE IF EXISTS `Cycms_voiceresponse`;
CREATE TABLE `Cycms_voiceresponse` (
  `id` int(11) NOT NULL auto_increment,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
  `createtime` varchar(13) NOT NULL,
...
#
# Data for table "Cycms_voiceresponse"
#

/*!40000 ALTER TABLE `Cycms_voiceresponse` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_voiceresponse` ENABLE KEYS */;

#
# Structure for table "Cycms_weather"
#

DROP TABLE IF EXISTS `Cycms_weather`;
CREATE TABLE `Cycms_weather` (
...
#
# Data for table "Cycms_wecha_user"
#

/*!40000 ALTER TABLE `Cycms_wecha_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_wecha_user` ENABLE KEYS */;

#
# Structure for table "Cycms_wxuser"
#

DROP TABLE IF EXISTS `Cycms_wxuser`;
CREATE TABLE `Cycms_wxuser` (
  `id` int(11) NOT NULL auto_increment,
  `uid` int(11) NOT NULL,
...
#
# Data for table "Cycms_wxuser"
#

/*!40000 ALTER TABLE `Cycms_wxuser` DISABLE KEYS */;
/*!40000 ALTER TABLE `Cycms_wxuser` ENABLE KEYS */;
